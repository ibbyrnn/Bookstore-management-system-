;----------------------------------TP071659 CSLLT FINAL ASM FILE----------------------------------------------
;----------------------------------------Muhammad Ibrahim Mirza-------------------------------------------------
.model small
.stack 100h
.data
        ...
        db 10, " Book Store Management System"
                db 10, "-------------------------------"
        ...
        db 10, "----- List of Available Books -----"
                ...
                db 10, "4. Back"
                db 10, "-------------------------"
                db 10, "Which Book do you want to buy?: $"

                purchaseItemInput db 10, "How many Copies of this Book?: $"
        ...
        Book2String db 10, "Book2    =  $"
        Book3String db 10, "Book3 =  $"

        manageInventoryMenu db 10,10,"1. Add Stock"
                db 10, "2. Back"
                db 10,10,"WARNING! If stock amount is highlighted,order more Stock!"
                db 10, "Input Choice: $"
        ...
        checkoutSuccessMessage db 10, 10, "Books purchased successfully!$"
...
printPurchaseItemHeader:
        ...
        ; Conditions
        cmp al, '1' ; If user wants to purchase Book1
        je purchaseBook1

        cmp al, '2' ; If user wants to purchase Book2
        je purchaseBook2

        cmp al, '3' ; If user wants to purchase Book3
        je purchaseBook3
...
purchaseBook1:
        ...
        purchaseItemMacro Book1Stock, Book1Price, cart[0]

purchaseBook2:

        purchaseItemMacro Book2Stock, Book2Price, cart[1]

purchaseBook3:

        purchaseItemMacro Book3Stock, Book3Price, cart[2]
...
printAddStockHeader:
        ...
        ; Conditions
        cmp al, '1' ; If user wants to add Book1
        je addBook1

        cmp al, '2' ; If user wants to add Book2
        je addBook2

        cmp al, '3' ; If user wants to add Book3
        je addBook3
...
addBook1:
        ...
        addStockMacro Book1Stock
        jmp addStockReturn

addBook2:

        addStockMacro Book2Stock
        jmp addStockReturn

addBook3:

        addStockMacro Book3Stock
        jmp addStockReturn
...
lowStock:
        ...
        mov cx, 1 ; Since lesser than 3 will only be highlighted, it will always be 1 character
        int 10h
        ret
...
printCart:
        ...
        ; Display Book2 String
        mov ah, 09h
        mov dx, offset Book2String
        int 21h

        printCartMacro cart[1]

        ; Display Book3 String
        mov ah, 09h
        mov dx, offset Book3String
        int 21h
...
MainInterface:
        ...
        ; Conditions
        cmp al, '1'
        je purchaseItem ; Page that allow user to purchase books
